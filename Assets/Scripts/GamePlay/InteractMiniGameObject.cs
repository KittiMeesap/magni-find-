...
public class InteractMiniGameObject : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        if (MinigameManager.Instance.IsPlayingMinigame == false && ToolManager.Instance.CurrentMode == "Eye")
        {
            ...
            CameraController.Instance.ZoomToObject(transform, () =>
            {
                ...
                Dialogue dialogueSystem = GetComponent<Dialogue>(); // แก้จาก DialogueManager เป็น Dialogue
                if (dialogueSystem != null)
                {
                    // เลือกข้อความที่จะแสดง
